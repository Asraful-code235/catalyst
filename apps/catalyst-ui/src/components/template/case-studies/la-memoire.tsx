import CaseStudiesGridSection from '@/components/organisms/case-study/CaseStudiesGridSection';
import PhaseSection from '@/components/organisms/case-study/CaseStudiesPhase';
import HeroSection from '@/components/organisms/case-study/HeroSection';
import WhyPartnerWithUs from '@/components/organisms/case-study/WhyWorkWithUs';
import {
  CaseStudyProps,
  GridSectionProps,
  PhaseProps,
