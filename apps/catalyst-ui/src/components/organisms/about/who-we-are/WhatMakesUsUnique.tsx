      ...
      <section className='relative w-full h-[430px] lg:h-[349px] max-lg:-mt-6'>
        ...
        <div className='z-10 absolute inset-0 flex items-center justify-center flex-col gap-8 text-white px-8 py-6 lg:py-16'>
          <Title
            type='h2'
            size='medium'
            className='max-[390px]:text-[28px] text-[32px] lg:text-4xl font-medium text-center text-white'
          >
            What Makes Us Unique
          </Title>
          <Text className='paragraph lg:text-base leading-[18px] max-[390px]:mt-0 max-lg:mt-4 lg:leading-6 font-normal max-w-[834px] mx-auto z-20 text-white '>
            ...
            client&apos;s success. With a broad range of services including
