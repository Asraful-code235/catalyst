      ...
      <div className="flex flex-col gap-6 md:gap-8 p-8 md:py-[149px] md:px-16 bg-primary">
        <div className="flex flex-col gap-6 md:gap-8 md:max-w-[506px] md:ml-auto">
          <p className="text-left md:text-right text-xs md:text-2xl leading-[150%]">
            “Here at Catalyst, we believe in a future where innovation isn't
            just a goal but a pathway to transformative change. By investing in
            visionary founders and companies worldwide, we're not only shaping
            industries but redefining what's possible for generations to come."
          </p>
